...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_testimonial_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" uuid NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_testimonial_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" uuid NOT NULL,
  	"_path" text NOT NULL,
  	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_testimonial_block_order_idx" ON "pages_blocks_testimonial_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_testimonial_block_parent_id_idx" ON "pages_blocks_testimonial_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_testimonial_block_path_idx" ON "pages_blocks_testimonial_block" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_testimonial_block_order_idx" ON "_pages_v_blocks_testimonial_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_testimonial_block_parent_id_idx" ON "_pages_v_blocks_testimonial_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_testimonial_block_path_idx" ON "_pages_v_blocks_testimonial_block" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "testimonials_author_author_photo_idx" ON "testimonials" USING btree ("author_photo_id");
